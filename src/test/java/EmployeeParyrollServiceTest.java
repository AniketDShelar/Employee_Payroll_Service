...
//    @Test
//    void givenThreeEmployeesAfterInConsoleWritingShouldReturnEntryCount(){
//        Employee employee1 = new Employee(1,"Amit",20000);
//        Employee employee2 = new Employee(2,"Neha",25000);
//        Employee employee3 = new Employee(3,"akash",30000);
//
...
//        list.add(employee3);
//
//        EmployeeParyrollService employeeParyrollService = new EmployeeParyrollService(list);
//        employeeParyrollService.writeData(EmployeeParyrollService.IOService.CONSOLE_IO);
//        employeeParyrollService.readData(EmployeeParyrollService.IOService.CONSOLE_IO);
//        long count = employeeParyrollService.countEntries(EmployeeParyrollService.IOService.CONSOLE_IO);
//        Assertions.assertEquals(3,count);
//    }
}
